...
export const CostsSaved: React.FunctionComponent<ICostsSavedProps> = (props: React.PropsWithChildren<ICostsSavedProps>) => {
    ...
    const YAxis: IKeyValue[] = [{ key: "1 Second", value: 1 / 60 / 60 }, { key: "5 Seconds", value: 5 / 60 / 60 }, { key: "30 Seconds", value: 30 / 60 / 60 }, { key: "1 Minute", value: 1 / 60 }, { key: "5 Minutes", value: 5 / 60 }, { key: "10 Minutes", value: 10 / 60 }, { key: "30 Minutes", value: 30 / 60 }, { key: "1 Hour", value: 1 }, { key: "6 Hours", value: 6 }, { key: "1 Workday", value: DailyHours }]
        ...
        <>
            <div className={mergeStyles(AnimationStyles.slideDownIn20, { margin: "1em" })}>
                ...
                <div style={{ display: 'flex', width: "100%", flexWrap: "wrap", gap: "1em" }}>
                    <Dropdown
                        styles={{ root: { flexGrow: 1, minWidth: 200, marginTop: "auto" } }}
                        label='View mode'
                    ...
                    <FormattedNumberField styles={{ root: { flexGrow: 1, minWidth: 200, marginTop: "auto" } }} type='number' currentValue={NumberOfEmployees} label='Number of employees' onValueChanged={val => SetNumberOfEmployees(val)} />
                    <Slider styles={{ root: { flexGrow: 1, minWidth: 200, marginTop: "auto" } }} value={SystemLifetime} step={1} onChange={val => SetSystemLifetime(val)} label='System life time (years)' min={1} max={15} />
                </div>
                ...
                <div className='TableWrapper'>
                    ...
                    <div style={{ flexGrow: 1, maxWidth: "100%", overflowX: "auto" }}>
                        ...
                        <div className='Table' style={{ display: "grid", gridTemplateColumns: `repeat(${XAxis.length + 1}, 1fr)` }}>
